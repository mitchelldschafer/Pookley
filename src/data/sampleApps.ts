...
export const invoicingApps: App[] = [
  {
    ...
    liveUrl: '/apps/invoicing',
    sourceUrl: 'https://github.com/pookley/invoicing',
  ...
  },
  {
    id: 'inv-2',
    name: 'Payment Links',
    description: 'Generate secure payment links for quick transactions and one-time payments.',
    technologies: ['React', 'Stripe API', 'TypeScript'],
    category: 'productivity',
    status: 'active',
    lastUpdated: '2024-01-19',
    liveUrl: '/apps/invoicing/payment-links',
  ...
  },
  {
    ...
    description: 'Track business expenses and generate reports for tax purposes and budgeting.',
    technologies: ['React', 'Supabase', 'Chart.js'],
    category: 'productivity',
    status: 'development',
    lastUpdated: '2024-01-18',
    liveUrl: '/apps/invoicing/expenses',
